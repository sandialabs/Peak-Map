...
namespace PeakMap
{
    ...
    {
        DialogResult ShowMessage(string message, string caption, MessageBoxButtons btns, MessageBoxIcon icon);
    }
    ...
    public class MessageDisplay : IDisplay
    {
        ...
        /// <param name="caption"> caption of title bar</param>
        /// <param name="btns"> message Box buttions</param>
        /// <param name="icon"> message Box icon</param>
        /// <returns></returns>
        public DialogResult ShowMessage(string message, string caption = "Message", MessageBoxButtons btns = MessageBoxButtons.OK, MessageBoxIcon icon = MessageBoxIcon.Exclamation)
        {
            return MessageBox.Show(message, caption, btns, icon);
        }
    }
